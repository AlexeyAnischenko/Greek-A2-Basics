...
| καταφέρνω | manage to | **κατάφερα** | να καταφέρω | — |
| μεταφέρω | transfer | **μετέφερα** | να μεταφέρω | — |
...
| λείπω | be absent | **έλειψα** | να λείψω | — |
| νιώθω | feel | **ένιωσα** | να νιώσω | — |
| πείθω | persuade | **έπεισα** | να πείσω | πείσε / πείστε |
| προσθέτω | add | **πρόσθεσα** | να προσθέσω | πρόσθεσε / προσθέστε |
